...
byte  buffer[]={0x03,0x67,0x00,0xBE,0x04,0x73,0x26, 0xB0}; //default LPP values 
...
static const u4_t DEVADDR = 0x0; //fill in your devaddr ; // <-- Change this address for every node!
...
#define LPP_BAROMETRIC_PRESSURE 115     // 2 bytes 0.1 hPa Unsigned.
  ...
  cursor=8;
    ...
    pascal=constrain(pascal,970,1034);    //pressure in range 970 to 1034 (64 steps)*/
        ...
        buffer[cursor++]=s_value&0xFF; //lower byte
        buffer[cursor++]=s_value>>8;   //higher byte
  }
  else
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    LMIC_setTxData2(1, (uint8_t*) buffer, cursor , 0);
...
void setup()
  ...
  Serial.begin(115200);
  delay(200);
  Serial.println(F("Workshop series, 2 of 4: TTN Integrations"));
